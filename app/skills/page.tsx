  ...
  return (
    <div className="py-32">
      <main className="px-5 md:p-0">
        <div className=" mb-16">
          <h2 className=" font-medium text-2xl mb-3 text-center">Tech Stack & Expertise</h2>
          <div className=" flex flex-wrap items-center justify-center gap-4 mt-4">
            <div className=" py-6 px-8 rounded-2xl text-center border-2 flex flex-col items-center justify-center">
              <FaReact className=" text-xl" />
              <span className=" text-sm mt-1">React js</span>
            </div>
        ...
        <div className="">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="font-medium text-2xl mb-3">Skills & Tech Stack</h2>
            <p className="text-slate-700">A comprehensive toolkit for building modern, scalable applications</p>
          </div>

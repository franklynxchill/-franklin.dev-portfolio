...
function ExperienceSection() {
    ...
    },
    {
      ...
      line4: "Independently completed a website redesign case study focused on improving usability, responsiveness, and modern UI standards.",
    },
    {
      role: "Full-Stack Developer",
      highligt: "Personal & Freelance Projects",
      period: "2024 – Present",
      line1: "Built full-stack applications using React, Next.js, Node.js, and REST APIs with authentication, database integration, and deployment workflows.",
      line2: "Implemented data flow between frontend and backend services, including CRUD operations and basic system design patterns",
      ...
      <section id="experience" className="py-24 container mx-auto" >
        <div className="px-5 md:p-0">
          <div className=" mb-14 text-center">
            ...
            <p className=" text-text-muted">A timeline of professional growth, achievements, and continuous learning</p>
          </div>
                ...
                <div key={index}>
                  <div className=" bg-white rounded-2xl shadow p-6">
                    <div className=" flex flex-col md:flex-row gap-y-3 md:items-center justify-between mb-4">
                      <div className="">
                        <h3 className=" font-bold text-background">{experience.role}</h3>
                        <p className=" text-text-muted">{experience.highligt}</p>
                      </div>
                      <div className=" text-background">
                        <p>{experience.period}</p>
                      </div>
                    </div>
                    <ul className=" list-disc px-6 text-surface">
